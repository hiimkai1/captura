...
from captura.blueprints.admin import admin_bp
from captura.blueprints.ajax import ajax_bp
from captura.blueprints.auth import auth_bp
from captura.blueprints.main import main_bp
from captura.blueprints.user import user_bp
from captura.extensions import bootstrap, db, login_manager, mail, dropzone, moment, whooshee, avatars, csrf
from captura.models import Role, User, Photo, Tag, Follow, Notification, Comment, Collect, Permission
from captura.settings import config
import os, click
...
def register_commands(app):
    ...
    def forge(user, follow, photo, tag, collect, comment):
        ...
        from captura.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, fake_collect

...
from captura.emails import send_change_email_email
from captura.extensions import db, avatars
from captura.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from captura.models import User, Photo, Collect
from captura.notifications import push_follow_notification
from captura.settings import Operations
from captura.utils import generate_token, validate_token, redirect_back, flash_errors
